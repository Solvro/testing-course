...
export class ExamConflicts {
  ...
  private convertToExam(
    ...
    return {
      ...
      durationMinutes:
        examRaw.durationMinutes,
      location:
        examRaw.location,
      fee: examRaw.fee,
      earlyBirdDeadline:
        new Date(
          examRaw.earlyBirdDeadline,
        ),
      registrationDeadline:
        new Date(
          examRaw.registrationDeadline,
        ),
    };
  }
   ...
   */
  async detectExamConflicts(): Promise<
    Conflict[]
  > {
